...
static inline QString i18nc(const char* y, const char* x){return QObject::tr(x, y);}
static inline QString i18nc(const char* y, const char* x, int n){return QObject::tr(x, y, n);}
static inline QString i18nc(const char* y, const char* x, const QString& s){return QObject::tr(x, y).arg(s);}
static inline QString i18nc(const char* y, const char* x, const QString& s1, const QString& s2){return QObject::tr(x, y).arg(s1).arg(s2);}
static inline QString i18nc(const char* y, const char* x, int n, int m){return QObject::tr(x, y).arg(n).arg(m);}
static inline QString i18n(const char* x, int n, int m){return QObject::tr(x).arg(n).arg(m);}
