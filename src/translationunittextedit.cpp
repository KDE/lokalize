...
#include "translationunittextedit.h"
#include "catalog.h"
#include "cmd.h"
...
public:
    ...
    bool eventFilter(QObject* , QEvent* ); //reimplemented to deliver more keypresses to TranslationUnitTextEdit
};
...
#if 1
class TranslationUnitTextEditSpellInterface: public KTextEditSpellInterface
{
public:
    TranslationUnitTextEditSpellInterface(SyntaxHighlighter* highlighter);
    ~TranslationUnitTextEditSpellInterface(){};
...
TranslationUnitTextEditSpellInterface::TranslationUnitTextEditSpellInterface(SyntaxHighlighter* highlighter)
...
void TranslationUnitTextEditSpellInterface::setSpellCheckingEnabled(bool enable)
{
    ...
    , m_completionBox(0)
{
    ...
    setSpellInterface(new TranslationUnitTextEditSpellInterface(m_highlighter));
...
#include "translationunittextedit.moc"
