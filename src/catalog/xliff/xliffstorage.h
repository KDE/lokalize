...
public:
    ...
    QStringList sourceAllForms(const DocPosition& pos) const{Q_UNUSED(pos); return QStringList();}
    QStringList targetAllForms(const DocPosition& pos) const{Q_UNUSED(pos); return QStringList();}
