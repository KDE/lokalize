...
QString GNUPluralForms(const QString &lang)
{
    ...
    arguments << QLatin1String("-l") << lang << QLatin1String("-i") << QLatin1String("-") << QLatin1String("-o") << QLatin1String("-")
              << QLatin1String("--no-translator") << QLatin1String("--no-wrap");
...
QString formatGettextDate(const QDateTime &dt)
{
    ...
    QString zoneOffsetString = (offset_seconds >= 0 ? QLatin1Char('+') : QLatin1Char('-')) + (offset_hours < 10 ? QStringLiteral("0") : QString())
        + QString::number(offset_hours) + (offset_minutes < 10 ? QStringLiteral("0") : QString()) + QString::number(offset_minutes);
                  ...
                  const QString &codec)
{
    ...
    langCode = Project::instance()->isLoaded() ? Project::instance()->langCode() : Settings::defaultLangCode();
