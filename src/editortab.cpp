...
void EditorTab::setupActions()
{
    ...
    // File
    action = file->addAction(KStandardActions::Save, this, &EditorTab::saveFile);
    ...
    file->addAction(KStandardActions::SaveAs, this, &EditorTab::saveFileAs);
...
#define ADD_ACTION_SHORTCUT(_name, _text, _shortcut)                                                                                                           \
    ...
    action = edit->addAction(QStringLiteral("edit_clear-target"), m_view->viewPort(), &TranslationUnitTextEdit::removeTargetSubstring);
    ...
    // MergeMode
    action = sync1->addAction(QStringLiteral("merge_open"), m_syncView, &MergeView::mergeOpen);
    ...
    // Secondary merge
    action = sync2->addAction(QStringLiteral("mergesecondary_open"), m_syncViewSecondary, &MergeView::mergeOpen);
